...
#
# Generated by Vivado on Mon Nov 27 10:41:56 +0100 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../p2230211.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../p2230211.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
